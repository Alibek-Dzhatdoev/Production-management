...
import com.novopacksv.production.repository.productRepository.ProductOperationRepository;
...
public class ProductOperationServiceImpl implements ProductOperationService {
    ...
    private Integer getChangingAmount(ProductOperation productOperation) {
        Integer amount;
        amount = productOperation.getProductOperationType().equals(ProductOperationType.MANUFACTURED) ?
                +productOperation.getAmount()
                : -productOperation.getAmount();
