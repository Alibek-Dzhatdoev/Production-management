...
import com.novopacksv.production.exception.NegativeAmountException;
import com.novopacksv.production.exception.ResourceNotFoundException;
import com.novopacksv.production.model.rollModel.*;
import com.novopacksv.production.repository.rollRepository.RollOperationRepository;
...
public class RollOperationServiceImpl implements RollOperationService {
    ...
    public RollOperation update(RollOperation rollOperation) throws NegativeAmountException {
        ...
        Integer differenceAmount = isItManufactureOperation(rollOperation)
                ? rollOperation.getRollAmount() - oldRollOperation.getRollAmount()
                : oldRollOperation.getRollAmount() - rollOperation.getRollAmount();
